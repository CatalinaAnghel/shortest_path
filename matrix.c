...
int generate_number_of_vertices(){
    	...
    	///Implements a very special operation: the generation of the number of vertices
    	int no_vertices;
    	time_t t;
...
int generate_node(int no_vertices){
    	...
    	///Implements a very special operation: the generation of a number which is used to determine the start and the destination vertex
...
void build_adjacency_matrix(int *adjacency_matrix[], int no_vertices){
    	...
    	///Implements a very special operation: the generation of the adjacency matrix
...
void print_matrix(int *matrix[], int no_vertices){
    	///\fn void print_matrix(int *matrix[], int no_vertices)
    	///\brief it prints the adjacency matrix
    	///\param *matrix[] First integer
    	///\param no_vertices Second integer
    	///
...
void print_cost_matrix(int *matrix[], int no_vertices){
    	///\fn void print_cost_matrix(int *matrix[], int no_vertices)
    	///\brief it prints the cost matrix
    	///\param *matrix[] First integer
    	///\param no_vertices Second integer
    	///
