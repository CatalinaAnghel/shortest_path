...
\begin{tabbing}
\indent{\Large{Student:}} {\Large{Anghel Florina-C\u{a}t\u{a}lina} }\\

\indent{\Large{Grupa:}} {\Large{CR1.1} }\\

\indent{\Large{Specializarea:}} {\Large{Calculatoare cu predare \^{i}n limba rom\^{a}n\u{a}}}
\end{tabbing}
